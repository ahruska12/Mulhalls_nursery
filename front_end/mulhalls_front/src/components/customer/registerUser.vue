            ...
            <div class="col col-12 col-sm-6 col-md-10 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form v-else ref="form" @submit.prevent="registerUser">
                            <div class="container-fuild">
                                ...
                                <div class="row justify-content-around">
                                    <button type="button" class="btn btn-primary col-4" @click="registerUser">Register</button>
                                    <button type="button" class="btn btn-secondary col-6" @click="login">Back to Login</button>
                                </div>
                            </div>
                        </form>
                    </div>
