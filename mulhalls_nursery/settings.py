"""
Django settings for mulhalls_nursery project.
...
SECRET_KEY = 'django-insecure-3kx603#!!et)md@z!o^wh)tzlfz)+5yjxsugms4sieqcgi=gy0'
...
ROOT_URLCONF = 'mulhalls_nursery.urls'
...
WSGI_APPLICATION = 'mulhalls_nursery.wsgi.application'
